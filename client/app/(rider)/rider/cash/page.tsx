// rider cod cash collection and remittance page on /rider/cash
'use client';
...
import { RiderCodRemittanceModal } from '@/components/rider/RiderCodRemittanceModal';
...
export default function RiderCashPage() {
  ...
  if (isProfileLoading) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-3">
        ...
        <p className="text-xs text-slate-400 font-semibold">Loading Cash Management...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-5 pb-6">
      <RiderCodRemittanceModal rider={rider} wallet={wallet} />
    </div>
  );
}
