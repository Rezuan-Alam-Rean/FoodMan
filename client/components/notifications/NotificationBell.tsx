  ...
  return (
    <>
      <button
        ...
        className="relative w-11 h-11 flex items-center justify-center rounded-2xl bg-white/90 hover:bg-slate-100 active:scale-[0.98] transition-transform border border-slate-200/80 text-slate-700 transition cursor-pointer shadow-xs focus:outline-none"
