// admin platform settings desk with tabs for platform fees/mfs, menu categories and upload endpoints
'use client';

import React, { useState } from 'react';
import { Sliders, UtensilsCrossed, Cloud } from 'lucide-react';
...
export function AdminSettingsDesk() {
  const [activeTab, setActiveTab] = useState<'platform' | 'categories' | 'uploads'>('platform');
