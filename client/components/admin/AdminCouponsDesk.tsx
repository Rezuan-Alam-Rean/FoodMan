    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 sm:p-5 rounded-3xl border border-slate-200 shadow-xs">
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-2xl bg-rose-600 hover:bg-rose-700 text-white text-xs font-bold transition flex items-center justify-center gap-1.5 shadow-md shadow-rose-600/20 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-3 gap-2.5">
        ...
        <div className="p-3.5 rounded-2xl bg-white border border-slate-200 shadow-xs">
          ...
          <span className="text-lg font-black text-emerald-600 mt-0.5 block">{activeCount}</span>
        </div>
        ...
        <div className="p-3.5 rounded-2xl bg-white border border-slate-200 shadow-xs">
          ...
          <span className="text-lg font-black text-indigo-600 mt-0.5 block">{totalUses}</span>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 text-xs font-bold placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500"
            />
          </div>
          ...
          <select
            ...
            className="px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-slate-900 text-xs font-bold focus:outline-none focus:ring-2 focus:ring-rose-500/20 cursor-pointer"
          >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0 self-end sm:self-center">
                    <button
                      ...
                      className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition flex items-center gap-1 cursor-pointer disabled:opacity-50 ${
                        coupon.is_active
                    ...
                    <button
                      ...
                      className="p-1.5 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 transition cursor-pointer disabled:opacity-50"
                      title="Delete coupon"
                    >
                      {isDeleting ? (
                        <Loader2 className="w-3.5 h-3.5 animate-spin" />
