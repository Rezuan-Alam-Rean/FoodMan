        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-4 sm:p-6 overflow-y-auto pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))] sm:pb-6">
              ...
              <div className="p-4 rounded-2xl bg-indigo-50/70 border border-indigo-100 space-y-3.5">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`min-h-[44px] px-3.5 py-2 rounded-xl text-xs font-black uppercase transition cursor-pointer active:scale-[0.98] transition-transform ${
            ...
            <button
              ...
              className="w-full min-h-[48px] py-3.5 rounded-2xl bg-slate-900 hover:bg-slate-800 active:scale-[0.98] transition-transform text-white text-sm font-black transition flex items-center justify-center gap-2 shadow-md cursor-pointer disabled:opacity-50 mt-3"
            >
