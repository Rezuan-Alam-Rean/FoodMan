...
export const updateMenuCategory = async (categoryId, updates, user) => {
  ...
  if (updates.sort_order !== undefined) category.sort_order = Number(updates.sort_order);
...
export const updateFoodItem = async (foodItemId, updates, user) => {
  ...
  if (updates.name) foodItem.name = updates.name.trim();
  if (updates.description !== undefined) foodItem.description = updates.description.trim();
  if (updates.image_url !== undefined) foodItem.image_url = updates.image_url;
  if (updates.base_price !== undefined) foodItem.base_price = Number(updates.base_price);
  if (updates.variants !== undefined) foodItem.variants = updates.variants;
  if (updates.add_ons !== undefined) foodItem.add_ons = updates.add_ons;
