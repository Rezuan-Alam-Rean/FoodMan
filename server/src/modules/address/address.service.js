...
export const updateUserAddress = async (userId, addressId, updates) => {
  ...
  if (updates.detailed_address) address.detailed_address = updates.detailed_address.trim();
  if (updates.contact_person_name) address.contact_person_name = updates.contact_person_name.trim();
  ...
  if (updates.address_label) address.address_label = updates.address_label;
